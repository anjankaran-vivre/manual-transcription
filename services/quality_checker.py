"""
Simplified Quality Checker for Streamlit
- Clean transcripts by removing excessive repetitions
- Check audio quality
"""
...
class QualityChecker:
    """Streamlit-optimized Quality Checker"""
    ...
    def clean_transcript(transcript):
        ...
        Keeps up to 4 consecutive repetitions
        """
        if not transcript:
            return transcript
